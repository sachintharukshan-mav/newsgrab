...
export async function GET() {
  const rawPubId = process.env.NEXT_PUBLIC_ADSENSE_PUB_ID || process.env.NEXT_PUBLIC_ADSENSE_CLIENT_ID || 'pub-0000000000000000';
...
# -------------------------------------------------------------
# Google AdSense & Google Ad Manager (Primary Direct Seller)
# -------------------------------------------------------------
